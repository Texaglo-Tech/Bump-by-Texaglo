...
import { addMembershipDiscount, exportToExcel, getUserIdFromToken } from "../../api";
...
const ProductData = () => {
  ...
  const exportData = async()=> {
    ...
    const data = [{Scans: summary_data.scans_cnt, Clicks: summary_data.clicks_cnt, "Online Sales": summary_data.online_sales_cnt, "Local Sales": summary_data.local_sales_cnt,      
    }]
    ...
    <>
      <div className={Style.Product_section}>
        <div className={Style.Product_post_section}>
          ...
          <button onClick={exportData} className={Style.Product_data_export_btn}>export data</button>
        </div>
        <div className={Style.Product_post_card_section}>
          <div className={Style.Product_post_card_box}>
            ...
            <div className={Style.Product_post_card}>
              ...
              <div  onClick={addMemberDiscount} className={Style.Product_card_download_btn}>
                Add member discount
              </div>
            </div>
            <p>
